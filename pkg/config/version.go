...
//
//	-X voicebot/pkg/config.Version=<version>
//	-X voicebot/pkg/config.GitCommit=<commit>
//	-X voicebot/pkg/config.BuildTime=<timestamp>
//	-X voicebot/pkg/config.GoVersion=<go-version>
var (
